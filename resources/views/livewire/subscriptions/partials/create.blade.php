<div>
    <flux:modal name="create-subscription" class="md:w-8/12 z-30">
        <div class="space-y-8">
            <div>
                <flux:heading size="lg">Enter New Subscription</flux:heading>
                <flux:subheading>Add details for the subscription.</flux:subheading>
            </div>
